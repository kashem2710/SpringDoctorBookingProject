...
<c:if test="${sessionScope.userId!=null && sessionScope.role == 1}">
    ...
    <a href="#">Home</a> | <a href="<s:url value="/admin/users"/>">Patient List</a> | <a href="${url_logout}">Logout</a>  
</c:if>
<c:if test="${sessionScope.userId!=null && sessionScope.role == 2}">
    ...
    <a href="${url_uhome}">Home</a> | <a href="${url_cform}">Booking now</a> | <a href="${url_clist}">Booking List</a> | <a href="${url_logout}">Logout</a>  
</c:if>
