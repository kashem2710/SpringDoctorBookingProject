...
<html>
    <head>
        ...
        <title>Booking List - Booking Application </title>
            ...
            <tr>
                <td height="350px" valign="top" width="100%">
                    ...
                    <c:if test="${param.act eq 'sv'}">
                        <p class="success">Booking confirm Successfully</p>
                    </c:if>
                    <c:if test="${param.act eq 'del'}">
                        <p class="success">Booking Deleted Successfully</p>
                    </c:if>
                        ...
                        <table border="1" cellpadding="3"  width="100%">
                            ...
                            <c:forEach var="c" items="${contactList}" varStatus="st">
                                <tr>
                                    ...
                                    <td><a href="${url_edit}">Edit Booking</a> | <a href="${url_del}">Cancel Booking</a></td>
                                </tr> 
                            </c:forEach>
                        </table>
                    </form>     
